...
import ScopeTwoLocationContent from "./scope-two-location-content"
import Image from "next/image"

export default function ScopeTwoLocationPage() {
  return (
    <SidebarProvider>
      <EnvironmentSidebar />
      <SidebarInset>
          ...
          <div className="flex items-center gap-2">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator className="hidden md:block" />
                <BreadcrumbItem>
                  <BreadcrumbPage>Scope Two - Location</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
